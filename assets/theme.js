...
(function ($) {
          ...
          $.each(cart.items, function (index, product) {
            ...
            if (product.line_level_discount_allocations.length !== 0) {
              for (var discount in product.line_level_discount_allocations) {
                amount =
                  product.line_level_discount_allocations[discount].amount;
  ...
  theme.headerNav = (function () {
    ...
    function init() {
      ...
      config.wrapperOverlayed = theme.settings.overlayHeader = $wrapper.hasClass(
      ...
      if (config.stickyEnabled) {
        ...
        $window.on(
          ...
          $.debounce(150, stickyHeaderCheck)
        );
      }
  ...
  theme.Slideshow = (function () {
    ...
    function slideshow(el, args) {
      ...
      this.settings = {
        ...
        fade: false,
        speed: args.speed ? args.speed : 200,
        draggable: true,
        touchThreshold: 5,
        pauseOnHover: false,
  ...
  theme.predictiveSearch = (function () {
    ...
    function init() {
      ...
      $(selectors.searchButton, selectors.wrapper).on(
        "click" + namespace,
        triggerSearch
      );
    ...
    function buildProducts(results) {
      ...
      for (var i = results.length - 1; i >= 0; i--) {
        ...
        var new_product = {
          ...
          on_sale:
            parseInt(product.compare_at_price_max) > parseInt(product.price),
    ...
    Product.prototype = $.extend({}, Product.prototype, {
      ...
      formSetup: function () {
        ...
        if (theme.settings.dynamicVariantsEnable) {
          this.$variantSelectors = $(this.selectors.formContainer).find(
      ...
      setCurrentVariantAvailability: function (variant) {
        ...
        this.disableVariantGroup(
          $(this.selectors.formContainer).find(".variant-input-wrap")
        );
      ...
      enableVariantOptionByValue: function (array, index) {
        var $group = $(this.selectors.formContainer).find(
        ...
        if (variant) {
          if (variant.available) {
            ...
            $(this.selectors.addToCart)
              ...
              .prop("disabled", false);
            var defaultText = $(this.selectors.addToCartText).data(
              "default-text"
            );
      ...
      updateUnitPrice: function (evt) {
        ...
        if (variant && variant.unit_price) {
          ...
          $(this.selectors.unitPriceBaseUnit).text(
            theme.Currency.getBaseUnit(variant)
          );
          $(this.selectors.unitWrapper)
            .removeClass("hide")
      ...
      toggleIncomingInventory: function (show, available, date) {
        ...
        if (show) {
          ...
          $(this.selectors.incomingInventory).removeClass("hide").text(string);
        } else {
      ...
      setSliderArgs: function () {
        ...
        var thumbnailsVertical = (this.settings.thumbVertical =
          this.$thumbSlider.data("position") === "beside" ? true : false);
        var thumbArrows = (this.settings.thumbArrows = this.$thumbSlider.data(
          "arrows"
        ));

        var slidesToShow =
          thumbnailsVertical && thumbArrows ? 1 : thumbnailsVertical ? 3 : 5;
  ...
  theme.VideoSection = (function () {
    ...
    function setVideoToBeInteractedWith($el) {
      ...
      $el.closest(selectors.promoContainer).addClass(classes.interactable);
    }
  ...
  theme.setGlobals = function () {
    ...
    if (theme.config.hasLocalStorage) {
      theme.recentlyViewed.localStorage = window.localStorage.getItem(
        "theme-recent"
      );
